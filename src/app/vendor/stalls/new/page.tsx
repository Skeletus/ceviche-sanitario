...
import { StallRegistrationForm } from "@/components/stalls/StallRegistrationForm";
          ...
          <section className="mx-auto w-full max-w-4xl px-6 py-8 sm:px-8 lg:px-10">
            <div className="mb-6">
              ...
              <h1 className="mt-3 text-3xl font-bold">
                Registrar puesto ambulante
              </h1>
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Registra la ubicacion y datos basicos del puesto para que pueda
                ser evaluado por la municipalidad.
              </p>
            </div>

            <StallRegistrationForm profile={profile} />
          </section>
        </main>
      )}
    </ProtectedRoute>
