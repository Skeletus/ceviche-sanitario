      ...
      <section className="mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-center gap-8 px-6 py-10 sm:px-8 lg:grid lg:grid-cols-[1fr_420px] lg:items-center lg:px-10">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 text-4xl font-bold leading-tight sm:text-5xl">
            Autenticacion y roles para el MVP sanitario
          </h1>
          <p className="mt-5 text-lg leading-8 text-slate-700">
            El acceso al dashboard se valida con Supabase Auth y cada usuario
            ve solo las opciones permitidas por su perfil registrado.
          </p>
          <Link
